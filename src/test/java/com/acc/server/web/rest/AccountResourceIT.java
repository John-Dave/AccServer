package com.acc.server.web.rest;

import static com.acc.server.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.acc.server.AccServerApp;
import com.acc.server.config.Constants;
import com.acc.server.domain.Authority;
import com.acc.server.domain.User;
import com.acc.server.repository.AuthorityRepository;
import com.acc.server.repository.UserRepository;
import com.acc.server.security.AuthoritiesConstants;
import com.acc.server.service.UserService;
import com.acc.server.service.dto.PasswordChangeDTO;
import com.acc.server.service.dto.UserDTO;
import com.acc.server.web.rest.vm.KeyAndPasswordVM;
import com.acc.server.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = AccServerApp.class)
